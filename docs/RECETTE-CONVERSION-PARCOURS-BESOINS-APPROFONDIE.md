...
| Création/reprise | Porteur de projet ou repreneur | Pas de liste universelle ni continuité automatique | `Présenter mon projet` | Modérée : projet parfois incomplet | `Création ou reprise d’entreprise` | Informations générales d’abord, pièces selon l’avancement ensuite | Pilier, RC, multirisque, dirigeant, deux guides | Présentation du projet / préparation | Types d’exigences et différence reprise/création insuffisants : corrigés | Validation métier requise |
