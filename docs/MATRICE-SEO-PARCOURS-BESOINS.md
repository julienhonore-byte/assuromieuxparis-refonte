...
| Création/reprise | projet, exigences, moyens, informations, blocs | hub et parcours voisins | pilier, trois produits, guides | obligations précises réservées à des contenus sourcés ; aucune garantie de placement ou de transfert | Validée sous réserve mineure pour préproduction |
