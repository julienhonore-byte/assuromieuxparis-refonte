# Matrice SEO — Pages MVP Assuromieux Paris
...
| Page | URL | Intention principale | Mot-clé principal | CTA principal |
|---|---|---|---|---|
| Accueil | `/` | Comprendre le positionnement et engager un audit | courtier assurance entreprise Paris | Demander mon audit gratuit |
| Audit | `/audit-assurances-entreprise/` | Comprendre et demander un audit de contrats | audit assurances entreprise | Demander mon audit |
| Assurances entreprises | `/assurances-entreprises/` | Identifier les protections et leur articulation | assurances entreprises | Faire analyser mes contrats |
| Transport | `/assurance-transport/` | Trouver un accompagnement sectoriel transport/logistique | assurance transport | Demander un audit sectoriel |
| BTP | `/assurance-btp-decennale/` | Comprendre l'approche globale BTP/décennale | assurance BTP décennale | Demander un audit BTP |
| Cabinet | `/cabinet/` | Comprendre le cabinet, son rôle et sa méthode | courtier assurance entreprise Paris | Découvrir notre méthode |

## 1. Accueil

- **URL :** `/`
- **Intention :** découvrir un cabinet de conseil et de courtage, comprendre sa différence et initier un échange.
...
- **URL :** `/audit-assurances-entreprise/`
- **Intention :** comprendre le déroulement, le périmètre, les documents et le livrable d'un audit.
- **Mot-clé principal :** `audit assurances entreprise`.
...
- **Risque de cannibalisation :** faible à modéré avec l'accueil sur « audit assurances ». La page Audit porte le processus détaillé ; l'accueil doit rester synthétique.

## 3. Assurances entreprises

- **URL :** `/assurances-entreprises/`
- **Intention :** comprendre les principales protections et pourquoi les contrats doivent être étudiés ensemble.
- **Mot-clé principal :** `assurances entreprises`.
- **Mots-clés secondaires :** `assurance professionnelle`, `programme assurance entreprise`, `RC professionnelle`, `multirisque professionnelle`, `cyberassurance entreprise`.
...
- **Risque de cannibalisation :** élevé à terme avec les futures pages RC Pro, flotte, cyber et santé. Cette page doit rester une page pilier et limiter le détail contractuel réservé aux pages filles.

## 4. Assurance transport

- **URL :** `/assurance-transport/`
- **Intention :** comprendre l'analyse sectorielle des risques de transport et logistique.
- **Mot-clé principal :** `assurance transport`.
...
- **Données structurées :** `Organization`, `BreadcrumbList`, `Service`.
- **Risque de cannibalisation :** élevé à terme avec les futures pages flotte, TPM et logistique. Conserver ici la vision sectorielle globale ; réserver les requêtes produit aux pages spécialisées.

## 5. Assurance BTP et décennale

- **URL :** `/assurance-btp-decennale/`
- **Intention :** comprendre l'articulation entre décennale, activités, attestations et autres contrats BTP.
- **Mot-clé principal :** `assurance BTP décennale`.
...
- **Liens sortants :** Audit, Assurances entreprises, Cabinet et contact.
- **Données structurées :** `Organization`, `BreadcrumbList`, `Service`.
- **Risque de cannibalisation :** modéré avec une future page purement décennale. La page actuelle doit rester orientée programme BTP global.

## 6. Cabinet

- **URL :** `/cabinet/`
- **Intention :** comprendre l'identité, le rôle, la méthode et l'implantation du cabinet.
- **Mot-clé principal :** `courtier assurance entreprise Paris`.
...
1. Valider domaine, titles, descriptions et formulations métier.
2. Vérifier que chaque page conserve un H1 unique.
3. Ajouter les pages légales et le sitemap avant ouverture de `robots.txt`.
4. Valider les données réglementaires et la présentation du cabinet.
