---
title: "Quelles assurances prévoir pour une PME ?"
...
keywords: ["assurances PME", "assurance entreprise", "programme assurances PME"]
canonical: "https://www.assuromieuxparis.com/ressources/guides/quelles-assurances-prevoir-pme/"
status: "review-required"
featured: true
readingTime: 8
relatedProducts: ["assurances", "audit", "rc", "multirisque", "flotte", "sante", "dirigeant", "cyber"]
relatedSectors: []
relatedArticles: ["comment-auditer-assurances-entreprise", "rc-professionnelle-rc-exploitation-differences"]
faq:
  - question: "Existe-t-il une liste d’assurances obligatoire pour toutes les PME ?"
    answer: "Non. Les obligations et besoins varient selon l’activité, les véhicules, la qualité d’employeur, les travaux réalisés et les engagements contractuels. Une vérification propre à l’entreprise est nécessaire."
  - question: "Faut-il commencer par la multirisque ou la responsabilité civile ?"
    answer: "Il faut commencer par les conséquences que l’entreprise ne peut pas absorber seule. Selon l’activité, elles peuvent concerner une responsabilité, un site, un véhicule, une personne ou une interruption."
draft: false
---
...
Certaines assurances peuvent être imposées par la loi ou les textes régissant une profession. D’autres répondent à un contrat client, un bail, un financement ou un choix de transfert de risque. Le [ministère de l’Économie](https://www.economie.gouv.fr/entreprises/gerer-ses-ressources-humaines-et-ses-salaries/professionnels-quelles-sont-les-assurances-obligatoires) rappelle que l’obligation dépend de l’entreprise et de l’activité exercée.
...
## 1. Partir de l’activité et des engagements
...
## 2. Examiner les locaux, biens et stocks
...
## 3. Distinguer véhicules, matériel et marchandises

Tout véhicule terrestre à moteur destiné à circuler doit disposer du socle de responsabilité civile prévu par les textes, comme l’explique [Service Public](https://www.service-public.gouv.fr/particuliers/vosdroits/F2628). Les garanties de dommages, vol, assistance ou véhicule de remplacement sont d’une autre nature et dépendent des options retenues.

Le matériel ou les marchandises présents dans un véhicule ne sont pas automatiquement traités par l’assurance automobile. Une PME doit distinguer le véhicule, son contenu, les responsabilités liées à une prestation et les conséquences d’une immobilisation.

## 4. Cartographier les responsabilités

Une réclamation peut provenir d’une prestation, d’un produit, d’un défaut, d’un retard, d’un dommage dans les locaux ou de la vie courante de l’exploitation. RC professionnelle et RC exploitation doivent être rapprochées des définitions du contrat.

Vérifiez les personnes assurées, plafonds, sous-limites, franchises, exclusions, sous-traitants et territoires. Certaines activités réglementées appellent des obligations ou garanties particulières ; il faut les vérifier profession par profession.

## 5. Intégrer les salariés et l’organisation sociale
...
## 6. Protéger le dirigeant sans confondre les besoins
...
## 7. Évaluer données, outils et dépendances numériques
...
Une cyberassurance peut prévoir des garanties ou des services de crise, mais leur présence, leurs limites et leurs conditions varient. Elle ne remplace pas la prévention ni les obligations applicables en matière de données.

## 8. Mesurer la continuité d’activité
...
## 9. Hiérarchiser plutôt qu’accumuler
