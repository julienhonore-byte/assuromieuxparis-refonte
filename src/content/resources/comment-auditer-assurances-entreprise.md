---
title: "Comment auditer les assurances de son entreprise ?"
description: "Une méthode pratique pour inventorier les contrats, rapprocher garanties et activité réelle, puis préparer des arbitrages d’assurance documentés."
slug: "comment-auditer-assurances-entreprise"
...
faq:
  - question: "Un audit conduit-il nécessairement à changer d’assureur ?"
    answer: "Non. L’analyse peut conduire à conserver un contrat, à le clarifier, à l’ajuster ou à consulter le marché. La décision dépend des écarts observés et des priorités de l’entreprise."
  - question: "Quels documents faut-il réunir en premier ?"
    answer: "Les conditions particulières et générales, avenants, attestations, échéanciers, questionnaires, relevés de sinistralité disponibles et principaux contrats clients constituent une première base utile."
draft: false
---
...
La méthode doit rester traçable : inventaire, description du risque, lecture des garanties, repérage des écarts, calendrier puis arbitrage. Un tableau synthétique aide, mais il ne remplace pas la lecture des pièces contractuelles.
...
## 1. Inventorier les contrats et leurs documents
...
## 2. Décrire l’activité telle qu’elle fonctionne aujourd’hui

L’entreprise doit pouvoir expliquer ses prestations, ses clients, ses sites, ses véhicules, ses salariés, ses sous-traitants et ses zones d’intervention. Ajoutez les changements récents : nouveau métier, acquisition, hausse de valeur, implantation, export, travaux nouveaux ou évolution du parc.

Cette description sert de référence. Elle permet de relire les activités déclarées, chiffres, surfaces, valeurs et usages inscrits dans les contrats. Un écart n’entraîne pas une conclusion automatique ; il signale une question à documenter auprès du courtier ou de l’assureur.

## 3. Examiner garanties, limites et franchises
...
## 4. Lire les exclusions avant de conclure
...
Faites de même avec les obligations de prévention et les déclarations exigées. L’analyse consiste à vérifier leur applicabilité et la capacité de l’entreprise à les respecter, sans présumer de l’effet juridique d’un manquement.

## 5. Exploiter la sinistralité
...
La sinistralité peut révéler une franchise mal calibrée, une procédure fragile, une déclaration à actualiser ou un besoin de prévention. Elle améliore également la qualité d’un dossier présenté au marché.

## 6. Rechercher lacunes, chevauchements et incohérences

Croisez maintenant les risques et les contrats. Les points de vigilance les plus fréquents concernent une activité absente du libellé, une valeur ancienne, des véhicules mal suivis, une sous-traitance non décrite, des territoires différents ou une interruption d’activité insuffisamment documentée.

Les chevauchements supposés doivent être vérifiés garantie par garantie. Deux contrats peuvent viser des responsabilités distinctes. Une zone sans contrat identifié n’est pas automatiquement assurable : elle peut relever de prévention, de clauses clients ou d’un risque conservé.

## 7. Organiser le calendrier et la consultation du marché
...
- [Ministère de l’Économie — assurances obligatoires des professionnels](https://www.economie.gouv.fr/entreprises/gerer-ses-ressources-humaines-et-ses-salaries/professionnels-quelles-sont-les-assurances-obligatoires), pour rappeler que les obligations dépendent de l’entreprise et de l’activité.
- [Service Public — obligation d’assurance d’un véhicule](https://www.service-public.gouv.fr/particuliers/vosdroits/F2628), pour distinguer le socle automobile obligatoire des garanties facultatives.
